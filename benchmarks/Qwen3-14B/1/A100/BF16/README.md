# Llama-3-70B-Instruct H100 BF16 Benchmark

## Model Attribution

This benchmark uses the **Meta Qwen 3 14B BF16** model.

- **Model**: [meta-llama/Qwen3-14B](https://huggingface.co/meta-llama/Qwen3-14B)
